...
public class Quickstart2 {
	...
	private static void processaUpInformes(Sheets service) throws IOException {
        ...
        versaoData.add("7.05.05");
        versaoData.add("10/05/2017");
        versaoDataInformes.add(versaoData);
        
        versaoData.clear();
        versaoData.add("7.06.05");
        versaoData.add("11/05/2017");
        versaoDataSdbanco.add(versaoData);
        
        versaoData.clear();
        versaoData.add("7.07.05");
        versaoData.add("12/05/2017");
        versaoDataSca.add(versaoData);
        
        versaoData.clear();
        versaoData.add("7.08.05");
        versaoData.add("13/05/2017");
	...
	private static void atualizaVersaoData(Sheets service, List<List<Object>> versaoEData, Celula celula)
			throws IOException {
